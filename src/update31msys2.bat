...
echo Creating output31msys2 directory tree

set CB_DEVEL_RESDIR=devel31msys2\share\CodeBlocks
set CB_OUTPUT_RESDIR=output31msys2\share\CodeBlocks

if not exist output31msys2 md output31msys2\
if not exist output31msys2\share md output31msys2\share\
...
if not exist devel31msys2 md devel31msys2\
if not exist devel31msys2\share md devel31msys2\share\
...
xcopy /D /y tools\ConsoleRunner\cb_console_runner.exe output31msys2 > nul
xcopy /D /y tools\ConsoleRunner\cb_console_runner.exe devel31msys2 > nul
xcopy /D /y devel31msys2\*.exe output31msys2 > nul
xcopy /D /y devel31msys2\*.dll output31msys2 > nul
xcopy /D /y %CB_DEVEL_RESDIR%\plugins\*.dll %CB_OUTPUT_RESDIR%\plugins > nul

echo Stripping debug info from output31msys2 tree
strip output31msys2\*.exe
strip output31msys2\*.dll
